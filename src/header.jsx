...
function Header() {
  return (
    <div className="relative overflow-hidden">
      <Popover as="header" className="relative">
          ...
          >
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  <span className="sr-only">Schoolsta</span>
                  <img
            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              ...
              <a
                href="#"
                className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-violet-900 hover:bg-white hover:text-green-900 hover:border-green-900"
              >
                Start free
              </a>
            </div>
        ...
        >
          <Popover.Panel focus className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
            <div className="rounded-lg shadow-md bg-white ring-1 ring-violet-900 ring-opacity-5 overflow-hidden">
              ...
              <div className="pt-5 pb-6">
                ...
                <div className="mt-6 px-5">
                  <a
                    href="#"
                    className="block text-center w-full py-3 px-4 rounded-md shadow text-white bg-violet-900 hover:bg-white hover:text-green-900 hover:border-green-900"
                  >
                    Start free
                  </a>
                </div>
      ...
      <main>
        <div className=" bg-indigo-50 -mb-16 sm:-mb-48 lg:m-0 lg:overflow-hidden">
          <div className="mx-auto max-w-7xl lg:px-4">
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div className="lg:py-24">
                  
                  <h1 className="text-4xl tracking-tight text-bold text-violet-900 sm:mt-5 sm:text-6xl lg:mt-6 xl:text-8xl">
                    <span className="block">The software</span>
                    <span className="block text-violet-900">Good education built on.</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-600 sm:mt-5 sm:text-xl lg:text-lg xl:text-3xl">
                  Hundreds of Successful Schools trust SchoolSta to 
                  Manage their Students and Staff Everywhere.
                  </p>
